    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="comentario.php" class="has-arrow waves-effect"><i class="mdi mdi-table-merge-cells"></i><span>comentario</span></a>
                </li>

                <li>    
                    <a href="contacto.php" class="has-arrow waves-effect"><i class="mdi mdi-poll"></i><span>contactos</span></a>
                </li>
                <li>
                    <a href="nosotros.php" class="has-arrow waves.affect"> <i class="mdi mdi-poll"></i> <span>Nosotros</span>
                    </a>
                </li>
            </ul>
        </div>

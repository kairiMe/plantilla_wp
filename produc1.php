                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img class="d-block img-fluid" src="img/pa1.jpg" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img width="100%" src="img/pa2.jpg" alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img width="100%" src="img/coco.jpg" alt="Third slide">
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <?php for ($i = 0; $i < 12; $i++) { ?>
                            <div class="col-lg-2 col-md-3 col-sm-6">
                                <!-- Simple card -->
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="img/coco.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Pastel de tres lechosas rico</h5>
                                        <p class="card-text">S/. 40.00 - S/. 80.00</p>
                                        <p class="card-tetle"> Un pastel decorado</p>
